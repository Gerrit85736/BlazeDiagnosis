...
export const chatThreads = pgTable(
  ...
  (table) => [index('chat_threads_tenant_job_idx').on(table.tenantId, table.jobCardId)],
);
...
export const notifications = pgTable(
  ...
  (table) => [index('notifications_recipient_idx').on(table.recipientUserId, table.status)],
);
